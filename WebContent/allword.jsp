...
<body>
		...
		<br/>
<div id="allword" style="width: 100%;height:400px;overflow: auto;"></div>
...
<script type="text/javascript">
        ...
        var myChart1 = echarts.init(document.getElementById('allword'));
            ...
            $.post(
                ...
                function(msg){
                    ...
                    for(i=0;i<size;i++){
                        ...
                        nums.push(json[i].confirm);
                        var a=json[i].name;
                        var b=json[i].confirm;
                        res.push("{name: \""+json[i].name+"\",value: "+json[i].confirm+"}");
                        //res.push(str);
                         alert(res);
                        i++;
                    }
                    ...
                    var option_container = {
                    	...
                    	myChart1.setOption(option_container);
                  ...
                  tr="<tr><th>省份</th><th>确诊人数</th><th>疑似人数</th><th>治愈人数</th><th>死亡人数</th><th>重症人数</th><th>编码</th><th>最后更新时间</th></tr>";
                  $('.head').append(tr);
                  for(i=0;i<size;i++)
                      $('.main').append("<tr></tr>");
